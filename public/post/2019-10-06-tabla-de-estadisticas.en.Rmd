...
Los datos están en formato tibble. CONTINUAR ACA
```{r} 
...
```{r}
head1 <- paste0("Conjunto entrenamiento (N=", sum(datos_train$n_train),")",collapse = "")
